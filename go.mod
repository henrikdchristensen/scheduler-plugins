...
require (
	...
	k8s.io/cloud-provider v0.32.7 // indirect
	...
	k8s.io/metrics v0.32.7 // indirect
...
replace (
	...
	k8s.io/kubernetes => k8s.io/kubernetes v1.32.7
...
replace k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.32.7

replace k8s.io/sample-controller => k8s.io/sample-controller v0.32.7
