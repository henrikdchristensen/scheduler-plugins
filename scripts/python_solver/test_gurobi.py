...
3. Size limits (limited license = 2000 vars/constraints)
...
def check_gurobi_license():
    ...
    try:
        ...
        # Use same WLS credentials as solver_gurobi.py
        ...
        print(f"Error: Gurobi license error: {e}")
        return False
...
def main():
    ...
    if not license_ok:
        print("\nWarning: Continuing with limited license (2000 vars max)...")
